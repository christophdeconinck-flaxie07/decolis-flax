#!/usr/bin/env python3
"""
Prefetch weather data for Flax Rainfall Monitor (FAST version).
...
def main():
    ...
    print(f"=== Flax Rainfall Monitor Prefetch (FAST) ===")
    ...
    print(f"{len(regions)} regions, {total_points} measurement points, {PARALLEL_WORKERS} parallel workers\n")
